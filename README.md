...
[本章代码](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/README.md)
...
服务器端代码请参见：[hello_server.c](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/hello_server.c)
...
客户端代码请参见：[hello_client.c](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/hello_client.c)
...
运行的时候，首先在 `9190` 端口启动服务，然后 `heserver` 就会一直等待客户端进行响应，当客户端监听位于本地的 IP 为 `127.0.0.1` 的地址的 `9190` 端口时，客户端就会收到服务端的回应，输出 `Hello World!`
...
代码见：[low_open.c](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/low_open.c)
...
代码见：[low_read.c](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/low_read.c)
...
代码见：[fd_seri.c](https://github.com/Corner430/TCP-IP-NetworkNote/ch01/fd_seri.c)
